        ...
        >
          ...
          <motion.div className="flex flex-col gap-4" variants={columnVariants}>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="riveted-btn text-on-secondary py-4 px-6 rounded-xl font-bold text-sm uppercase tracking-widest text-center flex items-center justify-center gap-3"
            >
